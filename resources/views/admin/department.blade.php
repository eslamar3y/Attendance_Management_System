...
<body>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-bottom-0">
                                <a href="/admin/edit/{{$user->id}}" style="font-size:25px;color:#539BFF;background: none;border: none;"><i class="ti ti-pencil"></i></a>
                                ...
                                <a href="/admin/profile/{{$user->id}}" style="font-size:25px;color:green;background: none;border: none;"><i class="ti ti-eye"></i></a>
                            </td>
                          </tr>
                          @endif
                        @endforeach
  ...
  {{-- <div class="modal fade" id="staticBackdrop3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdrop3Label" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title " id="staticBackdrop3Label">Add User</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
